    ...
    if (widget.customValidatorPattern != null) {
      if (value == null || value.isEmpty) {
        return widget.customValidatorMessage ??
            context.l10nCommon.field_error_required;
      }
      final regex = RegExp(widget.customValidatorPattern!);
      if (!regex.hasMatch(value)) {
        return widget.customValidatorMessage ??
            context.l10nCommon.field_error_invalid_format;
      }
      return null;
    }
  ...
  String _validatorMessage(FieldValidator v) {
    switch (v) {
      case FieldValidator.email:
        return context.l10nCommon.field_email_message;
      case FieldValidator.nip:
        return context.l10nCommon.field_nip_message;
      case FieldValidator.regon:
        return context.l10nCommon.field_regon_message;
      case FieldValidator.postalCode:
        return context.l10nCommon.field_postal_code_message;
      case FieldValidator.required:
        return context.l10nCommon.field_error_required;
